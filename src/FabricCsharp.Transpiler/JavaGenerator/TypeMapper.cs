...
public class TypeMapper
{
    ...
    private static readonly ImmutableHashSet<string> FabricCsharpApiTypes = new HashSet<string>
    {
        ...
        "FabricCsharp.Api.ItemStack",
        "FabricCsharp.Api.Hand",
        "FabricCsharp.Api.ServerWorld",
        "FabricCsharp.Api.Entity",
        "FabricCsharp.Api.DamageSource",
        "FabricCsharp.Api.ItemEntity",
        "FabricCsharp.Api.ScreenHandler",
        "FabricCsharp.Api.MinecraftClient",
        "FabricCsharp.Api.DrawContext",
        "FabricCsharp.Api.CallbackInfo",
        "FabricCsharp.Api.CallbackInfoReturnable`1",
        "FabricCsharp.Api.Direction",
        "FabricCsharp.Api.Commands.McCommand",
        "FabricCsharp.Api.Commands.CommandBuilder",
        "FabricCsharp.Api.Commands.CommandContext",
        "FabricCsharp.Api.Commands.CommandSource",
        "FabricCsharp.Api.Commands.Text",
        "FabricCsharp.Api.Network.ICustomPacketPayload",
        "FabricCsharp.Api.Network.PacketType",
        "FabricCsharp.Api.Network.PacketPayloadAttribute",
        "FabricCsharp.Api.Network.ServerNetworking",
        "FabricCsharp.Api.Network.ClientNetworking",
        "FabricCsharp.Api.Network.ServerPlayNetworking",
        "FabricCsharp.Api.Network.ClientPlayNetworking",
        "FabricCsharp.Api.Entities.EntityType`1",
        "FabricCsharp.Api.Entities.EntityType`1+Builder",
        "FabricCsharp.Api.Entities.SpawnGroup",
        "FabricCsharp.Api.Entities.EntityRendererRegistry",
        "FabricCsharp.Api.Entities.EntityRenderer`1",
        "FabricCsharp.Api.Entities.EntityRendererFactory",
        "FabricCsharp.Api.Entities.EntityRendererFactory+Context",
        "FabricCsharp.Api.Entities.DefaultAttributeRegistry",
        "FabricCsharp.Api.Entities.AttributeContainer",
    }.ToImmutableHashSet();
    ...
    private static readonly ImmutableDictionary<string, string> ApiToMinecraftMappings = new Dictionary<string, string>
    {
        ...
        ["FabricCsharp.Api.ItemStack"] = "net.minecraft.item.ItemStack",
        ["FabricCsharp.Api.Hand"] = "net.minecraft.util.Hand",
        ["FabricCsharp.Api.ServerWorld"] = "net.minecraft.server.world.ServerWorld",
        ["FabricCsharp.Api.Entity"] = "net.minecraft.entity.Entity",
        ["FabricCsharp.Api.DamageSource"] = "net.minecraft.entity.damage.DamageSource",
        ["FabricCsharp.Api.ItemEntity"] = "net.minecraft.entity.ItemEntity",
        ["FabricCsharp.Api.ScreenHandler"] = "net.minecraft.screen.ScreenHandler",
        ["FabricCsharp.Api.MinecraftClient"] = "net.minecraft.client.MinecraftClient",
        ["FabricCsharp.Api.DrawContext"] = "net.minecraft.client.gui.DrawContext",
        ["FabricCsharp.Api.Commands.CommandContext"] = "com.mojang.brigadier.context.CommandContext",
        ["FabricCsharp.Api.Commands.CommandSource"] = "net.minecraft.server.command.ServerCommandSource",
        ["FabricCsharp.Api.Commands.Text"] = "net.minecraft.text.Text",
        ["FabricCsharp.Api.Network.PacketType"] = "net.fabricmc.fabric.api.networking.v1.CustomPacketPayload.Type",
        ["FabricCsharp.Api.Entities.EntityType`1"] = "net.minecraft.entity.EntityType",
        ["FabricCsharp.Api.Entities.EntityRenderer`1"] = "net.minecraft.client.render.entity.EntityRenderer",
        ["FabricCsharp.Api.Entities.SpawnGroup"] = "net.minecraft.entity.SpawnGroup",
    }.ToImmutableDictionary();
